              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <div className="text-gray-800 dark:text-gray-100">Princesse</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">Princess@gmail.com</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">+234566666</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-sky-500">High Official</div>
                </td>
              </tr>
            </tbody>
          </table>
